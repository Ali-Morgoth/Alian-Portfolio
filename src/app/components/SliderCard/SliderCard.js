      ...
      <div className="h-[280px] lg:h-[450px] md:h-[400px] sm:h-[200px] lg:w-[650px] md:w-[450px] sma:w-[300px] w-[300px] relative m-auto">
        <div className="h-full w-full group cursor-all-scroll z-50 relative py-4 md:py-4">
          ...
          <div 
            ...
            className="absolute bottom-[100px] lg:bottom-44 md:bottom-32 sm:bottom-[270px] left-6 rounded-lg transition duration-300 opacity-0 group-hover:opacity-100 bg-[#000000] cursor-pointer flex items-center justify-center shadow-accent-color hover:shadow-xl hover:bg-[#47626D] w-10 h-10 md:w-12 md:h-12 lg:w-20 lg:h-20" 
            style={{ boxShadow: "#00bcd4 -10px 10px 20px 10px" }}
          >
            <svg
        ...
        >
          <div className="relative h-[200px] lg:h-[350px] md:h-[300px] w-[100%]">
            <p className="absolute bottom-3 left-4 text-lg font-[300] whitespace-nowrap overflow-hidden text-ellipsis pr-4">
              {item.name}
            </p>
          </div>
        </div>
